#
#  Be sure to run `pod spec lint WGBLE.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Eduoduo_RayMi" => "550621009@qq.com" }
  ...
  s.source_files  = "WGBLE", "WGBLE/*/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

   s.public_header_files = "WGBLE", "WGBLE/*/*.h"
